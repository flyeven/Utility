...
namespace Utility.ThirdpartUtility.Database
{
    public sealed class MySQLHelper
    {
        ...
        public static int ExecuteNonQuery(IDbTransaction transaction, CommandType commandType, string commandText, params IDbDataParameter[] commandParameters)
        {
            ...
            MySqlCommand cmd = new MySqlCommand();
            bool mustCloseConnection = false;
            PrepareCommand(cmd, transaction.Connection as MySqlConnection, transaction as MySqlTransaction, commandType, commandText, commandParameters as MySqlParameter[], out mustCloseConnection);
